...
class InfoPane:
    ...
    def initializeGhostDistances(self, distances):
        ...
        for i, d in enumerate(distances):
            t = text(
                self.toScreen(self.width / 2 + self.width / 8 * i, 0), GHOST_COLORS[i + 1], d, "Times", size, "bold"
            )
...
class PacmanGraphics:
    ...
    def make_window(self, width, height):
        ...
        begin_graphics(screen_width, screen_height, BACKGROUND_COLOR, "5242 Project")
    ...
    def drawWalls(self, wallMatrix):
        ...
        for xNum, x in enumerate(wallMatrix):
            ...
            for yNum, cell in enumerate(x):
                if not cell:  # There's a wall here
                    continue
    ...
    def updateDistributions(self, distributions):
        ...
        for x, distribution_col in enumerate(self.distributionImages):
            for y, image in enumerate(distribution_col):
